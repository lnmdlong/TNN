...
__kernel void Conv2DGS3D_EXP1_CB2(
    GLOBAL_SIZE_3_DIMS __read_only image2d_t input,
    __read_only image2d_t weights, __read_only image2d_t bias,
    __write_only image2d_t output, __private const int2 input_wh,
    __private const int in_channel_block_length, __private const int out_channel_block_length,
    ...
    const int batch_idx = mul24((output_bh_idx / output_wh.y), input_wh.y);
    const int weights_h_idx_s0 = mul24(out_channel_block_idx, mul24(kernel_wh.x, kernel_wh.y)) +
                              mul24(select(0, (-height_start + dilation_wh.y - 1) / dilation_wh.y, height_start < 0), kernel_wh.x);
    const int weights_h_idx_s1 = mul24(out_channel_block_idx + 1, mul24(kernel_wh.x, kernel_wh.y)) +
                              mul24(select(0, (-height_start + dilation_wh.y - 1) / dilation_wh.y, height_start < 0), kernel_wh.x);
    ...
    for (int input_c_block_idx = 0; input_c_block_idx < in_channel_block_length; ++input_c_block_idx) {
        ...
        for (int iy = in_height_start; iy < in_height_end; iy += dilation_wh.y) {
            ...
            for (int w = 0; w < kernel_wh.x; w++) {
                ...
                out_w0_s0 = mad(weights_c0_s0, in0.x, out_w0_s0);
                out_w1_s0 = mad(weights_c0_s0, in1.x, out_w1_s0);
                out_w2_s0 = mad(weights_c0_s0, in2.x, out_w2_s0);
                out_w3_s0 = mad(weights_c0_s0, in3.x, out_w3_s0);
                out_w0_s0 = mad(weights_c1_s0, in0.y, out_w0_s0);
                out_w1_s0 = mad(weights_c1_s0, in1.y, out_w1_s0);
                out_w2_s0 = mad(weights_c1_s0, in2.y, out_w2_s0);
                out_w3_s0 = mad(weights_c1_s0, in3.y, out_w3_s0);
                out_w0_s0 = mad(weights_c2_s0, in0.z, out_w0_s0);
                out_w1_s0 = mad(weights_c2_s0, in1.z, out_w1_s0);
                out_w2_s0 = mad(weights_c2_s0, in2.z, out_w2_s0);
                out_w3_s0 = mad(weights_c2_s0, in3.z, out_w3_s0);
                out_w0_s0 = mad(weights_c3_s0, in0.w, out_w0_s0);
                out_w1_s0 = mad(weights_c3_s0, in1.w, out_w1_s0);
                out_w2_s0 = mad(weights_c3_s0, in2.w, out_w2_s0);
                out_w3_s0 = mad(weights_c3_s0, in3.w, out_w3_s0);
                out_w0_s1 = mad(weights_c0_s1, in0.x, out_w0_s1);
                out_w1_s1 = mad(weights_c0_s1, in1.x, out_w1_s1);
                out_w2_s1 = mad(weights_c0_s1, in2.x, out_w2_s1);
                out_w3_s1 = mad(weights_c0_s1, in3.x, out_w3_s1);
                out_w0_s1 = mad(weights_c1_s1, in0.y, out_w0_s1);
                out_w1_s1 = mad(weights_c1_s1, in1.y, out_w1_s1);
                out_w2_s1 = mad(weights_c1_s1, in2.y, out_w2_s1);
                out_w3_s1 = mad(weights_c1_s1, in3.y, out_w3_s1);
                out_w0_s1 = mad(weights_c2_s1, in0.z, out_w0_s1);
                out_w1_s1 = mad(weights_c2_s1, in1.z, out_w1_s1);
                out_w2_s1 = mad(weights_c2_s1, in2.z, out_w2_s1);
                out_w3_s1 = mad(weights_c2_s1, in3.z, out_w3_s1);
                out_w0_s1 = mad(weights_c3_s1, in0.w, out_w0_s1);
                out_w1_s1 = mad(weights_c3_s1, in1.w, out_w1_s1);
                out_w2_s1 = mad(weights_c3_s1, in2.w, out_w2_s1);
                out_w3_s1 = mad(weights_c3_s1, in3.w, out_w3_s1);
            }
        }
    }
...
__kernel void Conv2DGS3D_EXP2_CB2(
    GLOBAL_SIZE_3_DIMS __read_only image2d_t input,
    __read_only image2d_t weights, __read_only image2d_t bias,
    __write_only image2d_t output, __private const int2 input_wh,
    __private const int in_channel_block_length, __private const int out_channel_block_length,
...
__kernel void Conv2DGS3D_EXP3_CB2(
    GLOBAL_SIZE_3_DIMS __read_only image2d_t input,
    __read_only image2d_t weights, __read_only image2d_t bias,
    __write_only image2d_t output, __private const int2 input_wh,
    __private const int in_channel_block_length, __private const int out_channel_block_length,
...
__kernel void Conv2DGS3D_EXP4_CB2(
    GLOBAL_SIZE_3_DIMS __read_only image2d_t input,
    __read_only image2d_t weights, __read_only image2d_t bias,
    __write_only image2d_t output, __private const int2 input_wh,
    __private const int in_channel_block_length, __private const int out_channel_block_length,
